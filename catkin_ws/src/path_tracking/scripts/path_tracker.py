...
MIN_LFD          = 4.0      # 3.0 을 시험했다가 되돌렸다. 아래 기록 참고.
                            ...
                            #   "짧게 보면 빨리 복귀한다"고 보고 3.0 을 시험했으나
                            #   실측은 반대였다(2026-07-29):
                            #     최악 CTE      1.79m -> 1.90m
                            #     탈출 후 진동   0.21m -> 0.53m
                            #     조향 요구      0.808 -> 0.968 rad
                            #   lfd 를 줄이면 pure_pursuit 이 더 세게 꺾으라고
                            #   요구하는데, MAX_STEER(0.65)에 이미 잘리고 있어
                            #   실제 조향은 늘지 않는다. 요구만 커진 채 예민해져서
                            #   탈출 후 되꺾음이 심해질 뿐이다.
                            #   병목은 전방주시거리가 아니라 조향 포화다.
MAX_LFD          = 20.0
